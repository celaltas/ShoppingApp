...
public class UpdateDialogForRec  extends AppCompatDialogFragment {

    private EditText dialogShoppingName;
    private EditText dialogShoppingPlace;
    private EditText dialogShoppingDate;
    public String id;
    private UpdateDialogRecListener listener;
    private DatePickerDialog.OnDateSetListener dateSetListener;

    public UpdateDialogForRec(String id) {
        this.id = id;
    }
        ...
        builder.setView(view)
                ...
                .setPositiveButton("Okay", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        listener.fetchText(shoppingName,shoppingPlace,shoppingDate, id);
    ...
    public void onAttach(@NonNull  Context context) {
        ...
        listener = (UpdateDialogRecListener) context;
    }

    public interface UpdateDialogRecListener{
        void fetchText(String shoppingName, String shoppingPlace, Date date, String id);
    }
}
